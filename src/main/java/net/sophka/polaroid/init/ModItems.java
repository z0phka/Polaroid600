...
public class ModItems {
    ...
    public static final DeferredItem<Item> CAMERA_600_AF = ITEMS.registerItem("camera_600_af", p -> new CameraItem(p,new CameraItem.CameraProperties().withAF()),p -> p.stacksTo(1).component(ModDataComponents.CAMERA_FILM, CameraFilm.EMPTY).component(ModDataComponents.EXPOSURE,0).component(ModDataComponents.AF,false));
